const iconPaths = {
  ...
  heart: (
    <>
      <path d="M12 20.3s-7.5-4.5-7.5-10a4.2 4.2 0 0 1 7.5-2.6 4.2 4.2 0 0 1 7.5 2.6c0 5.5-7.5 10-7.5 10Z" />
    </>
  ),
  comment: (
    <>
  ...
  send: (
    <>
      <path d="m3 11.7 18-8-6.4 16-3.4-6.7L3 11.7Z" />
      <path d="M21 3.7 11.2 13" />
    </>
  ),
}
